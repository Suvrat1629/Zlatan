...
object EngineConfigJson {
    fun parse(json: String): EngineConfig {
        ...
        return EngineConfig(
            ...
            blendMaxLambda = o.optDouble("blend_max_lambda", d.blendMaxLambda.toDouble()).toFloat(),
            blendMaxLambdaBike = o.optDouble("blend_max_lambda_bike", d.blendMaxLambdaBike.toDouble()).toFloat(),
