...
object EngineConfigJson {
    fun parse(json: String): EngineConfig {
        ...
        return EngineConfig(
            ...
            useMagHeading = o.optBoolean("use_mag_heading", d.useMagHeading),
            ekfInitialMountOffsetDeg = o.optDouble("ekf_initial_mount_offset_deg", d.ekfInitialMountOffsetDeg.toDouble()).toFloat(),
            ekfMountOffsetRandomWalkDegPerSqrtSec = o.optDouble("ekf_mount_offset_random_walk_deg_per_sqrt_s", d.ekfMountOffsetRandomWalkDegPerSqrtSec.toDouble()).toFloat(),
            ekfMagHeadingNoiseHighDeg = o.optDouble("ekf_mag_heading_noise_high_deg", d.ekfMagHeadingNoiseHighDeg.toDouble()).toFloat(),
            ekfMagHeadingNoiseMediumDeg = o.optDouble("ekf_mag_heading_noise_medium_deg", d.ekfMagHeadingNoiseMediumDeg.toDouble()).toFloat(),
